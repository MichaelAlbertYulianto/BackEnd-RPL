...
// const { put } = require("./routes/api/mahasiswa");
...
//                     variables: {
//                         url: {
//                             default: 'Will be replaced with ngrok URL'
//                         }
//                     }
//                 }
//             ],
...
//     // Get your endpoint online and update Swagger URL
//     ngrok.connect({ 
//         addr: port,
//         authtoken: '2opIoOe006scRFqVSXmTVioUQir_2PaXCcEszuWhBZ6F5xed1' // Pass authtoken directly
//     })
//     .then(listener => {
//         console.log(`Ingress established at: ${listener.url()}`);
//         // Update Swagger server URL with ngrok URL
//         swaggerSpec.servers[0].url = listener.url();
//         // Mount Swagger UI after URL is updated
